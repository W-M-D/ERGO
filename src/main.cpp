...
int main()
{
    ...
    std::forward_list <std::string> string_list; // list to store data strings if no internet connection exists
    auto string_iterator = string_list.before_begin(); // iterator for string list
