...
/*int CERGO_SERIAL::data_read(std::forward_list <uint8_t> & data_list)
{
  data_list = {0xB5,0x62,0xD,0x3,0x1C,0x0,0x0,0x8D,0xAF,0x5B,0x0,0x0,0x0,0x0,0xE1,0x82,0xAD,0x3,0xB3,0x80,0xC,0x0,0xE1,0x82,0xAD,0x3,0x3,0x38,0xF,0x0,0xFF,0xFF,
  0xFF,0xFF,0x6E,0xAB,0xB5,0x62,0x1,0x2,0x1C,0x0,0x58,0x83,0xAD,0x3,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x98,0xBD,0xFF,0xFF,0xFF,0xFF,0xFF
  ,0xFF,0x0,0x63,0x3F,0xEB,0x86,0x98};
  return 0;
}*/


/* // OLD READ FUNCTION LEFT FOR TESTING
void CERGO_SERIAL::data_read (std::forward_list <uint8_t> & data_list)
{
    auto it = data_list.before_begin();
    if (read(tty_fd,&data_in,1)>0)
    {
        data_list.emplace_after(it,data_in);
        Log->add("0x%X ", data_in);
    }
}*/
